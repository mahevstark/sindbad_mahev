...
export default class AddAddress extends Component {
  ...
  validate_form() {
    ...
    if (all.first_name == "") {
      ...
      var err = this.state.lang == "en" ? 'Please enter your first name.' : 'يرجى إدخال اسمك.'
    ...
    if (all.last_name == "") {
        // alert("Please enter your name");
        var err = this.state.lang == "en" ? 'Please enter your last name.' : 'يرجى إدخال اسمك.'
    ...
    if (all.address == "") {
      var err = this.state.lang == "en" ? 'Please enter address.' : 'الرجاء إدخال اسم المستخدم.'
    ...
    if (all.phone == "") {
        var err = this.state.lang == "en" ? 'Please enter your phone.' : 'الرجاء إدخال اسم المستخدم.'
    ...
    fetch(urls.API + 'add_address', {
      ...
      .then((responseJson) => {
        ...
        if (responseJson.action == "success") {
            ...
            this.dropDownAlertRef.alertWithType('success', 'Success', "Address has been added");
            ...
            <ScrollView
              ...
              <View style={{ flex: 1 }}>
                ...
                <View style={{ width: viewportWidth * (80 / 100), alignSelf: "center", marginTop: 10 }}>
                  <Text style={{ fontFamily: "p-bold", color: "#070704", fontSize: 22 }}>Shipping Address</Text>
                </View>
                <View style={{
                    ...
                    <View onLayout={event => {
                      ...
                      <View style={{ width: viewportWidth * (65 / 100), }}>
                        <TextInput
                          ...
                          onFocus={() => {
                            this.downButtonHandler(this.arr[11]);
                          }}
                        />
                      </View>
                    </View>
